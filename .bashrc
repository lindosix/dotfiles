...
# Modified by lindosix [no-email]
#
# Last modified: Tue Nov 20 22:04:47 CET 2012
# lindosix last mod: Wed Feb 1  21:48:55 GMT+0 2017 
...
# sudo fix with aliases
alias sudo='sudo '			# sudo requires space

# systemctl
alias sys='systemctl '			#  systemctl
alias sysr='systemctl --type=service'	#  systemctl services
alias syss='systemctl status'		#  systemctl status
